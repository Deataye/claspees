    ...
    <section className="bg-white min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:flex-1 flex flex-col font-montserrat justify-center items-center lg:items-end px-6 py-12 lg:pr-20 lg:py-0">
        <div className="max-w-md w-full">
          <h1 className="text-[#00AEEF] text-4xl lg:text-[50px] leading-tight font-extrabold mb-4 text-center lg:text-right">
            Hold Onto Your Style
          </h1>
          <p className="text-[#00AEEF] text-base lg:text-[22px] mb-8 text-center lg:text-right">
            Claspees keep your strings on your clothes and accessorize,
            well, anything they fit.
          </p>
          <div className="flex justify-center lg:justify-end">
            <button className="bg-[#7B2CBF] text-white px-8 py-4 min-w-52  rounded-full shadow-lg text-xl  font-extrabold hover:bg-[#5A1E8E] transition">
              Shop
            </button>
          </div>
        </div>
