  ...
  return (
    <header className="bg-[#FFFFF0] w-full fixed top-0 z-50 shadow-md">
      <div className="lg:max-w-[1100px] lg:mx-auto flex items-center justify-between py-4 px-4 lg:px-10">
        ...
        {/* Navigation Links */}
        <nav
          className={`lg:flex lg:space-x-6 text-purple-600 font-montserrat absolute lg:static top-full left-0 w-full bg-[#FFFFF0] lg:w-auto py-4 lg:py-0 shadow-md lg:shadow-none transition-transform duration-300 ${
